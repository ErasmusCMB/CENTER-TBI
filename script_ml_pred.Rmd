...
---
This is the script for the paper called "Machine learning has no added value in predicting outcome in traumatic brain injury: a CENTER-TBI study". 
...
labs <- labs[,.(first(Labs.DLGlucosemmolL), first(Labs.DLSodiummmolL), first(Labs.DLHemoglobingdL)), by=gupi]
...
models <- c("LR", "svmLinear", "rf", "nnet", "gbm", "lasso","ridge")
...
training an cross-validation (and saving): 
...
to create the tables in the appendix
```{r}
